...
export const scannerFieldAliases = {
  ...
  windDrift: aliases(["Wind drift", "Leeway", "WD"], ["Beschickung durch Wind", "Windabdrift", "WA", "BW"], ["Dérive due au vent", "Dérive au vent", "Dv"], ["Scarroccio", "Deriva vento", "Sc"]),
  ...
  currentDrift: aliases(["Current drift", "Current correction", "CD"], ["Beschickung durch Strom", "Stromabdrift", "SA", "BS"], ["Dérive due au courant", "Correction de courant", "Dc"], ["Deriva di corrente", "Correzione corrente", "Dc"]),
