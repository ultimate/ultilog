...
export const scannerFieldAliases = {
  ...
  compassCourse: aliases(["Compass course", "Compass heading", "CC"], ["Magnetkompass-Kurs", "Kompasskurs", "MgK"], ["Cap compas", "Route compas", "Cc"], ["Prora bussola", "Rotta bussola", "Pb"]),
  deviation: aliases(["Deviation", "Dev"], ["Ablenkung", "Deviation", "Abl"], ["Déviation", "Dev", "Dév"], ["Deviazione", "Dev"]),
  magneticCourse: aliases(["Magnetic course", "Magnetic heading", "MC"], ["missweisender Kurs", "magnetischer Kurs", "mwK"], ["Cap magnétique", "Route magnétique", "Cm"], ["Prora magnetica", "Rotta magnetica", "Pm"]),
  variation: aliases(["Variation", "Magnetic variation", "Var"], ["Missweisung", "magnetische Missweisung", "Mw"], ["Déclinaison", "Déclinaison magnétique", "Var"], ["Declinazione", "Declinazione magnetica", "Var"]),
  trueCourse: aliases(["True course", "True heading", "TC"], ["rechtweisender Kurs", "wahrer Kurs", "rwK"], ["Cap vrai", "Route vraie", "Cv"], ["Prora vera", "Rotta vera", "Pv"]),
