...
alter table users add column coordinate_format text not null default 'decimal';
alter table users add column distance_display_unit text not null default 'off';
