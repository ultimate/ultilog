...
export class LogLinesRepository {
  ...
  async insert(sheetId: string, sortOrder: number, line: LogLine, ownerId = "legacy-user") {
    ...
    await this.db.query(
      ...
      [scopedId(ownerId, sheetId), sortOrder, line.time, line.position, line.latitude, line.longitude, line.logNm, String(line.courseOverGround), String(line.compassCourse), String(line.waves), line.barometer, `${line.windDirection} ${line.windStrength}`.trim(), line.weather, line.sailNote, line.motorNote, line.windDirection, line.windStrength, line.windUnit, line.seaUnit, line.tide, line.tideUnit, line.moon, line.deviation, line.magneticCourse, line.variation, line.trueCourse, line.windDrift, line.courseThroughWater, line.currentDrift, line.courseOverGround, line.speedKn, line.sailSm, line.sailNote, line.motorSm, line.motorHours, line.motorNote, line.remarks],
    );
  }
