...
export function validateLogSheet(value: unknown): LogSheet {
  const boat = { id: "validation-boat", name: "", type: "Sail", registration: "", flagState: "", homePort: "", owner: "", dimensions: "", logfactor: 1, deviationTable: [] };
...
export function validateFocusedLogSheet(value: unknown): FocusedLogSheet {
  ...
  if ("copyProvenance" in value || "sourceDetails" in value) throw new LogbookValidationError("Copy provenance is server-managed and must be omitted.");
