...
export const defaultCrewForm: CrewForm = { id: "", name: "", nationality: "", role: "", embarkation: "", disembarkation: "", address: "", certificate: "", isPrimary: false };
...
export const crewToForm = (crew: Partial<CrewForm>): CrewForm => ({ id: crew.id ?? "", name: crew.name ?? "", nationality: crew.nationality ?? "", role: crew.role ?? "", embarkation: crew.embarkation ?? "", disembarkation: crew.disembarkation ?? "", address: crew.address ?? "", certificate: crew.certificate ?? "", isPrimary: crew.isPrimary ?? false });
