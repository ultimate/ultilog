...
export const defaultLineForm: LineForm = { time: "", position: "", latitude: "", longitude: "", weather: "", barometer: "", windDirection: "", windStrength: "", windUnit: "bft", seaState: "", seaUnit: "m", tide: "", tideUnit: "m", moon: "", magneticCourse: "", deviation: "", magneticCourseCorrected: "", variation: "", trueCourse: "", driftAngle: "", courseThroughWater: "", currentDrift: "", courseOverGround: "", speedKn: "", logNm: "", sailSm: "", sailNote: "", motorSm: "", motorHours: "", motorNote: "", remarks: "" };
