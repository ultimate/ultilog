...
export const POST = (request: Request) => authenticatedMutation(request, async ownerId => upsertBoat(validateBoat(await jsonBody(request, ENTITY_REQUEST_LIMITS.boat)), ownerId));
