...
export const DELETE = (request: Request, context: Context) => authenticatedMutation(request, async ownerId => deleteBoat((await context.params).id, await deleteRevision(request), ownerId));
