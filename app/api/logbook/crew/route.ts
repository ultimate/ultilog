...
export const POST = (request: Request) => authenticatedMutation(async ownerId => upsertCrewMember(validateCrewMember(await jsonBody(request, ENTITY_REQUEST_LIMITS.crew)), ownerId));
