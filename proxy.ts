...
export const config = {
  matcher: ["/((?!api/auth|api/register|api/demo-login|api/demo-cleanup|api/password-reset|login|register|forgot-password|reset-password|partners|_next/static|_next/image|favicon.ico).*)"],
};
