...
- **SQLite via Node.js** for local `npm run dev` usage when no PostgreSQL URL is configured.
...
- `app/lib/` contains server-only infrastructure such as the logbook persistence adapter.
