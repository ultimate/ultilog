...
describe("LogLinesRepository", () => {
  ...
  it("binds the scoped sheet id separately when inserting engine runtime", async () => {
    const db = new MockDatabase();
    const engineLine = { ...line, engineHours: { "main-engine": 1.25 } };
