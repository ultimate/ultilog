...
function logLineRow(): LogLineRow {
  const { position, weatherRemark, logNm, windDirection, windStrength, windUnit, waves, seaUnit, tideUnit, compassCourse, magneticCourse, trueCourse, windDrift, courseThroughWater, currentDrift, courseOverGround, speedKn, sailMiles, sailNote, motorMiles, motorHours, motorNote, ...rest } = line;
