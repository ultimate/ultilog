...
const sharedSheet = { sheet: { id: "sheet-1", title: "Shared passage", status: "Draft", boatId: "boat-1", route: { from: "A", to: "B", departed: "", arrived: "" }, crew: [], watchPlan: [], technicalChecks: [], lines: [] } satisfies LogSheet, boatName: "Aurora", capability: { canCopy: true, missingRequiredSections: [], requiresAuthentication: false }, ownerAvatar: "data:image/png;base64,b3duZXI=", showOwnerAvatarOnPrint: true };
